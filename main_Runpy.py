    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Karan S/Downloads/Attendance Management System using Face Recognition-20241203T142255Z-001/Attendance Management System using Face Recognition/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/Karan S/Downloads/Attendance Management System using Face Recognition-20241203T142255Z-001/Attendance Management System using Face Recognition/Attendance/Manually Attendance/-----Check attendence-----"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/Karan S/Downloads/Attendance Management System using Face Recognition/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/Karan S/Downloads/Attendance Management System using Face Recognition/Attendance/-----check attendence-----"')
    ...
    def log_in():
        ...
        if username == 'batman':
            if password == 'batman007':
                ...
                cs = "C:/Users/Karan S/Downloads/Attendance Management System using Face Recognition/StudentDetails/StudentDetails.csv"
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
